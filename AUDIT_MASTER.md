...
4. **F3, F6, ~~F8~~** — money is wrong on screen (FX P/L, COGS/gross profit, ~~payroll tax~~). Add tests. (**F8 ✅ resolved by removing the tax engine — FinFlow no longer calculates tax.**)
