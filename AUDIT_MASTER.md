...
### F54 🟠 HIGH — Team-member data scope is incoherent (reads actor-scoped, writes account-scoped) — **NEW → ✅ CORE FIXED + VERIFIED (2026-08-14, FIX HELD); payroll/banking/cogs residual + invite-flow gate remain**
